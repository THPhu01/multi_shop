...
@section('contentMain')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-validation">
                            <form class="form-valide" action="{{ route('admin.updateRole', [$editRole->id]) }}" method="POST"
                                id="form_edit_role" novalidate="novalidate">
                                @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" id="name" name="name"
                                            placeholder="Nhập tên vai trò.." value="{{ $editRole->name }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" id="desc" name="desc"
                                            placeholder="Nhập mô tả vai trò.." value="{{ $editRole->desc }}">
    ...
    <script>
        $("#form_edit_role").submit(function(e) {
            e.preventDefault();
